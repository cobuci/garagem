...
return [
    ...
    'hints' => [
        ...
        'texts'           => 'Add texts with their own color and font, then drag them on the preview to position.',
    ...
    'fields' => [
        ...
        'item_name'             => 'Item',
        'item_note'             => 'Note',
        'item_note_placeholder' => 'E.g. 5 pcs',
        'item_price'            => 'Price',
    ...
    'messages' => [
        ...
        'confirm_delete'        => 'Are you sure you want to delete this banner? This action cannot be undone.',
        ...
        'logo_missing'          => 'No logo uploaded. Add one under Administration → Brand Logo to unlock this option.',
