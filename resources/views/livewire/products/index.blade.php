<div x-data="{ showPrices: true }" class="space-y-6 flex flex-col min-h-0 w-full max-w-full">
    <div class="flex-none bg-gray-50 dark:bg-gray-900 pb-2 w-full max-w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
                ...
                <p class="text-lg font-bold text-gray-900 dark:text-white" :class="showPrices ? '' : 'blur-sm select-none'">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
                ...
                <p class="text-lg font-bold text-primary-600 dark:text-primary-400" :class="showPrices ? '' : 'blur-sm select-none'">
    ...
    <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col min-h-0 w-full max-w-full">
        ...
        @if ($this->selectedCategoryId !== 0 && $this->products instanceof \Illuminate\Contracts\Pagination\Paginator && $this->products->hasPages())
