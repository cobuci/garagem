<div class="min-h-screen flex flex-col md:flex-row bg-slate-50">
    <div class="hidden md:flex md:w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-center items-center p-12 text-white">
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8 sm:p-12 md:p-16 lg:p-24">
        <div class="w-full max-w-md space-y-8">
            <div class="md:hidden flex flex-col items-center mb-8">
                <h2 class="text-3xl font-bold text-slate-900 italic">{{ config('app.name') }}</h2>
            </div>
            ...
            @if($step == 1)
                <form wire:submit.prevent="sendOtp" class="space-y-6">
                    ...
                    <x-button
                        ...
                        primary
                        xl
                        class="w-full font-bold shadow-xl shadow-primary-500/20"
                ...
                <form wire:submit.prevent="verifyOtp" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <x-button
                            ...
                            primary
                            xl
                            class="font-bold shadow-xl shadow-primary-500/20"
                            wire:loading.attr="disabled"
