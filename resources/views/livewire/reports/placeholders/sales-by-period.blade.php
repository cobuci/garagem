<div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
    ...
    <div class="h-80 w-full bg-gray-50 dark:bg-gray-900/50 rounded-xl animate-pulse flex items-center justify-center">
        <x-icon name="chart-bar" class="w-12 h-12 text-gray-200 dark:text-gray-700" />
    </div>
</div>
